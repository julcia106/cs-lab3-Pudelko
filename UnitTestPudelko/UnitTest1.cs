...
namespace PudelkoTests
{
    ...
    public class UnitTestsPudelkoConstructors
    {
        ...
        [DataRow (1.5, 5.25, 1.5, 11.8125)]
        [DataRow (2.25, 1.25, 9.789, 27.5315625)]
        public void PropertyVolume(double a, double b, double c, double expected)
        {
            Pudelko p = new Pudelko(a, b, c);

            Assert.AreEqual(expected, p.Volume);
        }

        [DataTestMethod]
        [DataRow(1.0, 2.0, 3.0, 12.0)]
        [DataRow(1.5, 5.25, 1.5, 16.5)]
        [DataRow(2.25, 1.25, 9.789, 26.578)]
        public void PropertyArea(double a, double b, double c, double expected)
        {
            Pudelko p = new Pudelko(a, b, c);

            Assert.AreEqual(expected, p.Area);
        }
        ...
        [DataRow(1.15, 2.50, 3, 1.15, 2.50, 3, true)]
        [DataRow(9.67, 4.50, 1.123, 9.67, 4.50, 1.123, true)]
        [DataRow(9.67, 7.50, 1.123, 4.67, 1, 1.12, false)]
        [DataRow(2, 1.50, 8.333, 9.67, 3.50, 1, false)]
        [DataRow(4.01, 4.001, 1.123, 7, 4.50, 1.123, false)]
        public void IsEqual(double a, double b, double c, double aa, double bb, double cc, bool expected)
        {
            Pudelko p1 = new Pudelko(a, b, c);
            Pudelko p2 = new Pudelko(aa, bb, cc);
        ...
        [DataTestMethod, TestCategory("OperatorOverloading")]
        [DataRow(1, 2, 3, 1, 2, 3, true)]
        [DataRow(1.15, 2.50, 3, 1.15, 2.50, 3, true)]
        [DataRow(9.67, 4.50, 1.123, 9.67, 4.50, 1.123, true)]
        [DataRow(9.67, 7.50, 1.123, 4.67, 1, 1.12, false)]
        [DataRow(2, 1.50, 8.333, 9.67, 3.50, 1, false)]
        [DataRow(4.01, 4.001, 1.123, 7, 4.50, 1.123, false)]
        public void OverloadingOperatorIsEqual(double a, double b, double c, double aa, double bb, double cc, bool expected)
        {
            Pudelko p1 = new Pudelko(a, b, c);
            Pudelko p2 = new Pudelko(aa, bb, cc);
        ...
        [DataRow(1.15, 2.50, 3, 1.15, 2.50, 3, false)]
        [DataRow(9.67, 4.50, 1.123, 9.67, 4.50, 1.123, false)]
        [DataRow(9.67, 7.50, 1.123, 4.67, 1, 1.12, true)]
        [DataRow(2, 1.50, 8.333, 9.67, 3.50, 1, true)]
        [DataRow(4.01, 4.001, 1.123, 7, 4.50, 1.123, true)]
        public void OverloadingOperatorIsNotEqual(double a, double b, double c, double aa, double bb, double cc, bool expected)
        {
            Pudelko p1 = new Pudelko(a, b, c);
            Pudelko p2 = new Pudelko(aa, bb, cc);
            Assert.AreEqual(expected, p1 != p2);
        ...
        [DataTestMethod, TestCategory("OperatorOverloading")]
        [DataRow(1, 2, 3, 0.5, 1, 2, 1, 2, 3)]
        [DataRow(1.15, 2.50, 3, 1, 2, 3, 1, 2.50, 3)]
        [DataRow(9.67, 4.50, 1.123, 9.6, 4.2, 1, 9.67, 4.50, 1.123)]
        [DataRow(9.67, 7.50, 1.5, 4.67, 1, 1.12, 9.76, 7.50, 1.5)]
        [DataRow(2, 1.50, 8.333, 9.67, 3.50, 1, 9.67, 3.50, 8.333)]
        [DataRow(4.01, 4.001, 1.123, 7, 4.50, 1, 7, 4.50, 1.123)]
        public void PlusOperatorOverloading(double a, double b, double c, double aa, double bb, double cc,
            double expected_a, double expected_b, double expected_c)
        {
            Pudelko p1 = new Pudelko(a, b, c);
            Pudelko p2 = new Pudelko(aa, bb, cc);
            Pudelko p3 = p1 + p2;

            Assert.AreEqual(expected_a, p3.A);
            Assert.AreEqual(expected_b, p3.B);
            Assert.AreEqual(expected_c, p3.C);
        }
